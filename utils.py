...
class listaOrdenada(Queue):
    def __init__(self):
        self.L = []

    def append(self, item):
        self.L.append(item) #no se ordena solo se usa para colocar el nodo de inicio.
...
class listaOrdenadaH(Queue):
    def __init__(self):
        self.L = []

    def append(self, item): # funcion):
        self.L.append(item) #no hace falta ordenarlo solo se usa para colocar el nodo de inicio.
        #funcion(self)
    ...
    def extend(self, items):
        self.L.extend(items)
        self.L.sort(key=lambda x: x.path_cost + x.heuristica)
